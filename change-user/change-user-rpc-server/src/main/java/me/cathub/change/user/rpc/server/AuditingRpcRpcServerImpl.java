...
import me.cathub.change.api.rpc.server.user.AdminRpcRpcServer;
...
@Service
public class AuditingRpcRpcServerImpl implements AuditingRpcRpcServer {

    @Autowired
    private AuditingCrud auditingDao;

    @Autowired
    private AdminRpcRpcServer adminRpcServer;
