...
public class Storehouse implements Serializable {
    ...
    private long storehouseCountryId;
    ...
    public long getStorehouseCountryId() {
        return storehouseCountryId;
    }

    public void setStorehouseCountryId(long storehouseCountryId) {
    ...
    public String toString() {
        ...
        sb.append(", storehouseCountryId=").append(storehouseCountryId);
