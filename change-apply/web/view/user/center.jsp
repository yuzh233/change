...
<head>
    ...
    <link rel="stylesheet" href="<%=webapp%>/resources/css/user/center.css" />
</head>
                ...
                <div class="tab-content" id="panes">
                    ...
                    <div class="tab-pane active" id="home">
                            ...
                            <div class="col-12 p-md-4">
                                <form>
                                    <div class="form-group">
                                        <label for="onname">网店名称：</label>
                                        <input type="text" class="form-control" placeholder="请输入网店名称">
                                    </div>
                                    <div class="form-group">
                                        <label for="onurl">网店地址：</label>
                                        <input type="text" class="form-control" placeholder="请输入网店url地址" name="url" v-model="regonlineStore.url">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleFormControlSelect1">支持推送平台</label>
                                        <select class="form-control" id="exampleFormControlSelect1" v-model="regonlineStore.type">
                                    ...
                                    <button type="button" class="btn btn-primary" @click="onlineStorereg">申请</button>
                                    <button type="reset" class="btn btn-danger">清空</button>
                                    <div :style="{color:onlineStorestatus.status==-1?'red':'green',margin:'10px'}">{{onlineStorestatus.msg}}</div>
                                </form>
                            </div>
                        </div>
                        <!--  -->
                        ...
                        <div class="row wd">
                            ...
                            <%--</div>--%>
                            <%----%>
                            <div class="col-md-4" v-for="item in onlineStore">
                                <a href="#" class="item mt-3">
                                    <div class="logo">
                                        <span v-if="item.type==1">ebay</span>
                                        <span v-if="item.type==2">amazon</span>
                                    </div>
                                    <div class="p-2">
                                        <div class="url mt-2">{{item.url}}</div>
                                        <div class="mt-2">
                                            <div class="row no-gutters">
                                                <div class="col-6 text-left text-secondary">{{item.createDate}}</div>
                                                <div class="col-6 text-right">已通过</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="op">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-12 ">
                                        ...
                                        <div class="row no-gutters p-2 orderlist">
                                                ...
                                                <div class="row no-gutters justify-content-center align-items-center text-center">
                                                    <div class="col-4 ">
                                                        <a href="#" class="d-flex align-items-center product">
                                                            <img src="<%=webapp%>/resources/img/commodity/1.webp.jpg" alt="" style="width: 80px;height: 80px;margin: 0 8px 0 0;"> 新款超厚短袖新款超厚短袖新款超厚短袖新款超厚短袖新款超厚短袖
                                                        </a>
                                                    </div>
                                                    <div class="col">
                                                        50.00
                                            ...
                                            <!--<img src="<%=webapp%>/resources/img/commodity/1.webp.jpg" alt=""-->
...
<script type="text/javascript">
    ...
    let vue = new Vue({
        ...
        data: {
            ...
            onlineStorestatus:{status:-1,msg:''}
        },
        created() {
            let _this = this;
            axios.get('<%=webapp%>/shopkeeper/onlineStore')
                .then(function (response) {
                    _this.onlineStore = response.data
        ...
        methods: {
            onlineStorereg() {
                let _this = this;
                axios.get('<%=webapp%>/shopkeeper/onlineStorereg', {
                    params: {
                        url: _this.regonlineStore.url,
                        type: _this.regonlineStore.type
                    }
                })
                    .then(function (response) {
                        _this.onlineStorestatus =response.data
